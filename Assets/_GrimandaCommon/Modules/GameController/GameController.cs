...
namespace Grimanda.Common
{
    public class GameController : MonoBehaviour
    {
        ...
        public CommonGameConfig activeGameConfig;
        ...
        public void ChangeActiveGameConfig(CommonGameConfig gameConfig)
        {
        ...
        {
            activeGameConfig = Resources.Load<CommonGameConfig>("Data/GameConfig1");
            ...
            if (activeGameConfig.isAvatarSystemAvailable)
            {
